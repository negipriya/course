          ...
          <div class="verfy_area">
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <form enctype="multipart/form-data" method="post" id="addcourse">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="course_title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Course Title">
                ...
                <div class="col-sm-4">
                        ...
                        <div id="image">
                   <img width="100%" height="100%" id="preview_image" src="{{asset('storage/uploads/default.png')}}"/>
    ...
    function upload(img) {
        ...
        j.ajax({
            ...
            success: function (data) {
                if (data.fail) {
                  j('#preview_image').attr('src', '{{asset('storage/uploads/images/default.png')}}');
                    alert(data.errors['file']);
                }
                else {
                    j('#file_name').val(data);
                    j('#preview_image').attr('src', '{{asset('storage/uploads/images/')}}/' + data);
